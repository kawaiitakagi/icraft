...
INP_W = 256
INP_H = 256
TRACED_MODEL_PATH = "../2_compile/fmodel/rdn_2x_"+str(INP_H)+"x"+str(INP_W)+".pt"
if __name__ == '__main__':
    parser = argparse.ArgumentParser()
    # parser.add_argument('--weights-file', type=str, required=True)
    # parser.add_argument('--image-file', type=str, required=True)
    parser.add_argument('--pt-file', type=str, required=False,default=TRACED_MODEL_PATH)
    ...
    device = 'cpu'
    model = torch.jit.load(args.pt_file,map_location=device)
