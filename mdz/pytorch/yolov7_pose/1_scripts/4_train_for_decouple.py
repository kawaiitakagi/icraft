...
from models.yolo import Model,IKeypoint
...
def IKP_decouple_forward(self, x):
...
if __name__ == '__main__':
    IKeypoint.forward = IKP_decouple_forward
    parser = argparse.ArgumentParser()
    parser.add_argument('--weights', type=str, default='../weights/yolov7-w6-pose.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default='../0_yolov7_pose/cfg/yolov7-w6-pose.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='coco_kpts.yaml', help='data.yaml path')
    parser.add_argument('--hyp', type=str, default='../0_yolov7_pose/data/hyp.pose.yaml', help='hyperparameters path')
    ...
    parser.add_argument('--name', default='yolov7-w6-pose-decouple-1010', help='save to project/name')
