...
int main()
{
	try{
		...
		//encoder_input
		std::vector<int64_t> encoder_input_dims = {1, 4};
		...
		std::cout<< "output1: " << encoder_input_data[0] << std::endl;
		std::cout<< "output1: " << encoder_input_data[1] << std::endl;
		std::cout<< "output1: " << encoder_input_data[2] << std::endl;
		std::cout<< "output1: " << encoder_input_data[3] << std::endl;	
		...
		// print output 
		int64_t* output1 = outputs[0].GetTensorMutableData<int64_t>();
		std::cout<< "output1: " << output1[0] << std::endl;	
	}
