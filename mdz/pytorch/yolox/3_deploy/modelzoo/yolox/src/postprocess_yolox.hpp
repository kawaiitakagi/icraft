...
void post_detpost_hard(std::vector<int> real_out_channels, const std::vector<Tensor>& output_tensors, PicPre& img, NetInfo& netinfo, std::vector<std::vector<float>>norm,
