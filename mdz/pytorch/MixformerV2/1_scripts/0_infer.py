...
def main():
    ...
    parser.add_argument('--tracker_param', type=str,default="224_depth4_mlp1_score", help='Name of config file.')
    ...
    parser.add_argument('--params__model', type=str, default="../weights/mixformerv2_small.pth.tar", help="Tracking model path.")
