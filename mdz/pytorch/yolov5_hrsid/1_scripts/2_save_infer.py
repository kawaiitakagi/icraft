...
def pred_one_image(img_path, model_path, test_size):
    ...
    for i in range(3):
        ...
        outputs[i] = outputs[i].view(bs, 3, 6, ny, nx).permute(0, 1, 3, 4, 2).contiguous()
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_pt', type=str, default=R'../2_compile/fmodel/YoloV5s_hrsid_640x640.pt', help='torchscript model path')
    parser.add_argument('--source', type=str, default=R'..\2_compile\qtset\hrsid\test_4.jpg', help='image path')
