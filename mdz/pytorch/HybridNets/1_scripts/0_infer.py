...
def parse_args():
    ...
    parser.add_argument('--output', type=str, default='demo_result/0_infer/', help='Output folder')
...
if __name__ == '__main__':
    ...
    with torch.no_grad():
        ...
        anchors.numpy().astype(np.float32).tofile('./anchors_384x640.ftmp')#[1,46035,4]
