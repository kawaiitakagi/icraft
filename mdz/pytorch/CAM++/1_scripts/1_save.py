...
add_arg('model_path',       str,    '../weights/CAMPPlus_Fbank/best_model/', '模型权重文件路径')
add_arg('dst_path',         str,    '../2_compile/fmodel/CAM++_predictor_1x365x80.onnx', '导出的onnx模型文件路径')
...
# dummy_input = torch.ones((1,1998,80))
