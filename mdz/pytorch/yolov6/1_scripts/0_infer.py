...
@staticmethod
def new_font_check(font='../0_yolov6/yolov6/utils/Arial.ttf', size=10):
...
Inferer.font_check = new_font_check

def get_args_parser(add_help=True):
    parser = argparse.ArgumentParser(description='YOLOv6 PyTorch Inference.', add_help=add_help)
    parser.add_argument('--weights', type=str, default='../weights/yolov6s_v2_reopt.pt', help='model path(s) for inference.')
    parser.add_argument('--source', type=str, default='../0_yolov6/data/images', help='the source path, e.g. image-file/dir.')
    parser.add_argument('--yaml', type=str, default='../0_yolov6/data/coco.yaml', help='data yaml file.')
