...
$url_qtset = "https://download.fdwxhb.com/data/04_FMSH-100AI/100AI/04_modelzoo/modelzoo_pub/compile/qtsets/JL-DCF/"
& $wget_path $url_qtset --user $usrname --password $password -r -np -nH -c --reject="index.html*" -P './' --cut-dirs=8
Set-Location $oriModelPath

# io
Set-Location ./3_deploy/modelzoo/JL-DCF/io/
$url_io = "https://download.fdwxhb.com/data/04_FMSH-100AI/100AI/04_modelzoo/modelzoo_pub/deploy/modelzoo/JL-DCF/io/"
