...
# io
Set-Location ./3_deploy/modelzoo/yolo11_pose/io/
$url_io = "https://download.fdwxhb.com/data/04_FMSH-100AI/100AI/04_modelzoo/modelzoo_pub/deploy/modelzoo/yolo11_pose/io/"
