import sys
sys.path.append(R"../0_yolo11_pose")
...
# Load a model
weigths = torch.load("../weights/yolo11s-pose.pt" , map_location="cpu")
...
torch.jit.save(torch.jit.trace(model,torch.randn(1,3,640,640,dtype=torch.float32)),"../2_compile/fmodel/yolo11s-pose-640x640.pt")
#torch.jit.save(torch.jit.trace(model,torch.randn(1,3,352,640,dtype=torch.float32)),"../2_compile/fmodel/yolo11s-pose-352x640.pt")