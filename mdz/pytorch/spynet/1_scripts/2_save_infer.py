...
def estimate(tenOne, tenTwo):
    ...
    if netNetwork1 is None:
        netNetwork1 = Network().eval()
    # end
    ...
    tenFirst1 =  netNetwork1.netPreprocess(tenPreprocessedOne) 
    tenSecond1 =  netNetwork1.netPreprocess(tenPreprocessedTwo) 
    netNetwork = torch.jit.load(TRACED_MODEL_PATH)
