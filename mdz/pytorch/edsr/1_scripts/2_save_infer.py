...
def main():
    ...
    # 加载经过跟踪的模型
    loaded_model = torch.jit.load("../2_compile/fmodel/edsr_gelu_160x240.pt")
    # loaded_model = torch.jit.load("../2_compile/fmodel/edsr_big_gelu_160x240.pt")
    loaded_model.eval()
    # 加载特定的图像
    ...
    cv2.imwrite("../3_deploy/modelzoo/edsr/io/test/save_infer_45.png", output_image_cv)
