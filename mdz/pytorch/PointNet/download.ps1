...
$url_qtset = "https://download.fdwxhb.com/data/04_FMSH-100AI/100AI/04_modelzoo/modelzoo_pub/compile/qtsets/modelnet40/"
& $wget_path $url_qtset --user $usrname --password $password -r -np -nH -c --reject="index.html*" -P './' --cut-dirs=8
Set-Location $oriModelPath

# io
Set-Location ./3_deploy/modelzoo/PointNet/io/
$url_io = "https://download.fdwxhb.com/data/04_FMSH-100AI/100AI/04_modelzoo/modelzoo_pub/deploy/modelzoo/PointNet/io/"
