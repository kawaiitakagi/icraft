...
def main():
    ...
    image_dir = '../0_U2Net_portrait/test_data/test_portrait_images/your_portrait_im'
    prediction_dir = './results/portrait_infer'
    if(not os.path.exists(prediction_dir)):
        os.makedirs(prediction_dir)

    model_dir = '../weights/u2net_portrait.pth'#'./saved_models/u2net_portrait/u2net_portrait.pth'
